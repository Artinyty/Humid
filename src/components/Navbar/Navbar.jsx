...
const Navbar = () => {
  return (
    <nav className={s.nav}>
      ...
      <div className={s.item}><NavLink to='/setings' className={navData => navData.isActive ? s.active : s.item}>Setings</NavLink></div>

      <div className={s.item}><NavLink to='/frends' className={navData => navData.isActive ? s.active : s.item}>Friends</NavLink></div>
